...
// lets file have access to shapes.js

describe('triangle', () => {
    test('should return true if a triangle generates with the correct color, text, and text color', () => {
        // sets up what we're going to be testing for
        const newTriangle = new triangle();
        newTriangle.shapeColor = "blue";
        newTriangle.textColor = "white";
        newTriangle.text = "SVG";
        // makes a new instance of triangle with shape color set to blue, text color set to white, and text set to SVG
...
// makes sure that the created SVG file reads the way we expect it to, and that it matches what the output should be
